...
public class Crafting extends Script {
    ...
    private final String GEM_TO_CUT = "Uncut emerald";
    ...
    public void onPaint(Graphics2D g){
        ...
        g.drawString("XP/H: "+ GUI.formatValue(getExperienceTracker().getGainedXPPerHour(skillToTrack)), 10, 104+16);
        if (breakingStatus) {
    ...
    public int onLoop() throws InterruptedException {
        try {
            if (System.currentTimeMillis() > nextPause) {
                ...
                breakingStatus = true;
                nextPause = System.currentTimeMillis() + (long) random(25, 50) * 1000 * 60;
...
//            if (getSkills().getStatic(Skill.CRAFTING) >= 70) {
...
//            }
            ...
            if (end_time-start_time>600 || getDialogues().isPendingContinuation() || !getInventory().contains(GEM_TO_CUT)) {
    ...
    private void setMouseProfile() {
        ...
        profile.setSpeedBaseTime(150); //185
